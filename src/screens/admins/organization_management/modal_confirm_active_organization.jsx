...
function ModalConfirmActiveOrganization(props){
    ...
    const activeOrganization = (id,flag) => {
        managementApi.activeOrganization({
            id:id,
            flag:flag
        }).then((response)=>{
            let mounted = true;
        ...
        <>
            ...
            className="modal-active">
                ...
                <div className="text-center box-modal-action">
                    <Button type="button" className="btn btn-info" onClick={()=>activeOrganization(props.id,props.flag)}>OK</Button>
...
export default ModalConfirmActiveOrganization;