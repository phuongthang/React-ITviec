...
function ModalConfirmDeleteOrganization(props){
    ...
    const deleteOrgaization = (id) => {
        managementApi.deleteOrganization({id:id}).then((response)=>{
            let mounted = true;
            if(mounted){
        ...
        <>
            ...
            className="modal-confirm">
                ...
                <div className="text-center box-modal-action">
                    <Button type="button" className="btn btn-info" onClick={()=>deleteOrgaization(props.id)}>OK</Button>
...
export default ModalConfirmDeleteOrganization;