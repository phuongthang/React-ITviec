...
function ModalConfirmDeleteJob(props){
    ...
    const deleteJob = (id) => {
        managementApi.deleteJob({id:id}).then((response)=>{
            let mounted = true;
            if(mounted){
        ...
        <>
            ...
            className="modal-confirm">
                ...
                <div className="text-center box-modal-action">
                    <Button type="button" className="btn btn-info" onClick={()=>deleteJob(props.id)}>OK</Button>
...
export default ModalConfirmDeleteJob;