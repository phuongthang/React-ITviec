...
function ModalConfirmActiveCV(props){
    ...
    const activeCV = (id,flag) => {
        managementApi.activeCV({
            id:id,
            flag:flag
        }).then((response)=>{
            let mounted = true;
        ...
        <>
            ...
            className="modal-active">
                ...
                <div className="text-center box-modal-action">
                    <Button type="button" className="btn btn-info" onClick={()=>activeCV(props.id,props.flag)}>OK</Button>
...
export default ModalConfirmActiveCV;