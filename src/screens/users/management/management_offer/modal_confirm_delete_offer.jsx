...
function ModalConfirmDeleteOffer(props){
    ...
    const deleteOffer = (id) => {
        managementApi.deleteOffer({id:id}).then((response)=>{
            let mounted = true;
            if(mounted){
        ...
        <>
            ...
            className="modal-confirm">
                ...
                <div className="text-center box-modal-action">
                    <Button type="button" className="btn btn-info" onClick={()=>deleteOffer(props.id)}>OK</Button>
...
export default ModalConfirmDeleteOffer;