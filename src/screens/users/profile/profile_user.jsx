            ...
            profileApi.getProfile({
                ...
                if (mounted) {
                    if (response.status === Constants.HTTP_STATUS.OK) {
                        ...
                        setAvatar(response.data.user.image?response.data.user.image:'/local/default.png');
                    }
                }
                                ...
                                <form className="form-horizontal form-material">
                                    <div className="form-group">
                                        ...
                                        <div className="col-md-12">
                                            <input className="form-control form-control-line" defaultValue={user.fullname} name="fullname" onChange={handleChange} />
                                        </div>
                                    </div>
                                    <div className="form-group">
                                        <label className="col-md-12">Vị trí :</label>
                                        <div className="col-md-12">
                                            <input className="form-control form-control-line" defaultValue={user.position} name="position" onChange={handleChange} />
                                        </div>
                                    </div>
                                    <div className="form-group">
                                        <label className="col-md-12">Địa chỉ :</label>
                                        <div className="col-md-12">
                                            <input className="form-control form-control-line" defaultValue={user.address} name="address" onChange={handleChange} />
                                        </div>
                                    </div>
                                    <div className="form-group">
                                        <label className="col-md-12">Số điện thoại :</label>
                                        <div className="col-md-12">
                                            <input className="form-control form-control-line" defaultValue={user.phone} name="phone" onChange={handleChange} />
                                        </div>
                                    </div>
                                    <div className="form-group">
                                        <label className="col-md-12">Mô tả :</label>
                                        <div className="col-md-12">
                                            <textarea rows={5} textmode="MultiLine" className="form-control form-control-line" defaultValue={user.description} name="description" onChange={handleChange} />
                                        </div>
                                    </div>
                                    <div className="form-group">
