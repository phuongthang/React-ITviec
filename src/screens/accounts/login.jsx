            ...
            <div className="main">
                ...
                <div className={!isSignUp?"container b-container is-txl is-z200":"container b-container"} id="b-container" >
                    <form className="form" id="b-form" onSubmit={SignIn}>
                        ...
                        <input className="form__input" type="password" name="password_signin" value={signInFormValue.password_signin} onChange={handleChangeSignIn} placeholder="Password" /><Link to={Constants.LINK_URL.FORGOT_PASSWORD} className="form__link">Quên mật khẩu ?</Link>
